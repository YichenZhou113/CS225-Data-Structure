...
class KDTree
{
  public:
    ...
    int partition(int dimension, int left, int right, int pivotIndex);
    void quickselect(int dimension, int left, int right, int k);
    void builder(int left, int right, int dimension);
    ...
    Point<Dim> nearestneighbor(int left,int right, int dimension, const Point<Dim>& query) const;
